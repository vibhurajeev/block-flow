...
//Have to do this as typescript cannot resolve Web3 and Long type otherwise.
const Long = LongImport as unknown as typeof LongClass;
...
export class BlockFormatter {
    ...
    protected formatRawReceipt(receipt?: IRawReceipt): ITransactionReceipt | void {
        ...
        return this.formatTransactionReceipt({
            ...receipt,
            blockNumber: utils.hexToNumber(receipt.transactionIndex),
            cumulativeGasUsed: utils.hexToNumber(receipt.cumulativeGasUsed),
            transactionIndex: utils.hexToNumber(receipt.transactionIndex),
            gasUsed: utils.hexToNumber(receipt.gasUsed),
