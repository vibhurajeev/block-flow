...
import { ICoderConfig } from "../../interfaces/kafka_coder_config.js";
...
export abstract class AbstractConsumer extends noderdkafka.KafkaConsumer {
     ...
     * @param {ICoderConfig} coders  - Object with coder instances where key is the topic name. 
     * @param {ConsumerGlobalConfig} config - Key value pairs to override the default config of the consumer client
