import { ISynchronousProducerConfig } from "../../interfaces/synchronous_producer_config.js";
...
export class SynchronousProducer extends AbstractProducer {
     ...
     * @param {ISynchronousProducerConfig} config - ey value pairs to override the default config of the producer client.
     */
    constructor(
        serialiser: ICoder,
        config: ISynchronousProducerConfig
    ) {
